...
class bc_modules(Model):
	...
	'inherits': fields.one2many(label ='Inherit Models', obj = 'bc.model.inherits', rel = 'module_id',readonly=True),
	'objs': fields.one2many(label ='Reports', obj = 'bc.objs', rel = 'module_id',readonly=True),
...
class bc_ui_model_view_columns(Model):
	...
	'seq': fields.integer(label='Sequence', readonly = True),
	'col': fields.referenced(label='Column',obj='bc.model.columns', on_delete = 'c'),
	#'col': fields.varchar(label='Column', readonly = True),
	'template': fields.text(label='Template'),
	'render': fields.text(label='Render')
	}
...
class bc_ui_model_view_column_inherits(Model):
	...
	'col': fields.referenced(label='Column',obj='bc.model.inherit.inherits', on_delete = 'c'),
	#'col': fields.varchar(label='Column', readonly = True),
	'i18n': fields.text(label='I18N'),
	'template': fields.text(label='Template'),
	'render': fields.text(label='Render'),
