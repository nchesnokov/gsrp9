...
class hcm_department(Model):
	...
	'fullname': fields.tree(label='Full Name', priority=1, translate = True,required = True),
	'complete_name': fields.composite(label='Complete Name',cols=['company','fullname'], priority=2, translate = True,required = True),
...
class hcm_employees(Model):
	...
	'fullname': fields.composite(label='Full Name', cols = ['lastname','firstname','middlename','birthday'], translate = True,required = True),
