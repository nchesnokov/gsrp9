...
class mrp_demand(Model):
	...
	'fullname': fields.composite(label='Full Name', cols = ['company','dtype','name'], translate = True,required = True),
...
class mrp_request(Model):
	...
	'name': fields.varchar(label = 'Name'),
	'company': fields.many2one(label='Company',obj='md.company'),
	'fullname': fields.composite(label='Full Name', cols = ['company','rtype','name'], translate = True,required = True),
