...
class purchase_orders(Model):
	...
	'market_id': fields.referenced(label='Market',obj='purchase.markets'),
	'team_id': fields.referenced(label='Team',obj='purchase.teams'),
	'category_id': fields.referenced(label='Category',obj='purchase.order.categories'),
	...
	'partner': fields.referenced(label='Partner',obj='md.partner',domain=[('issuplier',)]),
	'currency': fields.referenced(label='Currency',obj='md.currency',state={'approved':{'ro':True}}),
	'incoterms1': fields.referenced(label='Incoterms 1',obj='md.incoterms'),
	...
	'bom': fields.referenced(label='BoM',obj='md.boms',domain=[('usage','=','pur'),'|',('usage','=','all')],on_change='_on_change_bom'),
